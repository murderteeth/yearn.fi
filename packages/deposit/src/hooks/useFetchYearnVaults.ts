...
import { fetchWithSchema, getFetchQueryKey, useFetch } from '@yearn/components/hooks/useFetch'
...
import { YEARN_VAULT_LIST_ENDPOINT } from '@yearn/deposit/data/publicQueryEndpoints'
import type { TDict } from '@yearn/util/types/mixed'
import { toAddress } from '@yearn/util/utils/address'
import { patchYBoldVaults } from '@yearn/vaults/domain/normalizeVault'
...
import { isCatalogYearnVault } from '@yearn/vaults/utils/catalogYearnVault'
import { useEffect, useMemo } from 'react'

const DEFAULT_CHAIN_IDS = depositConfig().chains.map((network) => network.id)
