...
import { getBalanceQueryRefetchConfig } from '@yearn/deposit/hooks/balanceQueryConfig'
...
export const ENSO_SUPPORTED_CHAINS = depositConfig()
  .chains.map((n) => n.id)
  .filter((id) => !ENSO_UNSUPPORTED_NETWORKS.includes(id))
