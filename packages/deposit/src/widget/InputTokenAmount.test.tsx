...
async function loadInputTokenAmount() {
  return (await import('@yearn/deposit/widget/InputTokenAmount')).InputTokenAmount
}
...
vi.mock('@yearn/components', () => ({
  useYearnWallet: () => ({
    openLoginModal: vi.fn()
  })
}))

vi.mock('@yearn/util/utils/cl', () => ({
...
// directly while the rest came via the shared utils barrel. Now that the barrel
// is gone, keep the real implementation and override only the two.
...
vi.mock('@yearn/components/components/TokenLogoV2', () => ({
