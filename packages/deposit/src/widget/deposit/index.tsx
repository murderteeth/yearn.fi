...
import { WIDGET_EVENTS } from '@yearn/deposit/config/events'
import { useYearn } from '@yearn/deposit/contexts/useYearn'
import { useTokenListActions } from '@yearn/deposit/contexts/WithTokenList'
import { useDebouncedInput } from '@yearn/deposit/hooks/useDebouncedInput'
import type { VaultUserData } from '@yearn/deposit/hooks/useVaultUserData'
import { useYearnSpotPrices } from '@yearn/deposit/hooks/useYearnSpotPrices'
import { AnnualReturnOverlay } from '@yearn/deposit/widget/deposit/AnnualReturnOverlay'
import { ApprovalOverlay } from '@yearn/deposit/widget/deposit/ApprovalOverlay'
import { ApprovalResetWarning } from '@yearn/deposit/widget/deposit/ApprovalResetWarning'
import { shouldBlockDepositApprovalForAllowanceReset } from '@yearn/deposit/widget/deposit/approvalReset'
import { getDepositApprovalSpender } from '@yearn/deposit/widget/deposit/approvalSpender'
import { DepositDetails } from '@yearn/deposit/widget/deposit/DepositDetails'
import { buildSafeDepositBatch } from '@yearn/deposit/widget/deposit/safeDepositBatch'
import { getStructurallyExcludedDepositTokenAddresses } from '@yearn/deposit/widget/deposit/tokenSelectorFiltering'
import type { DepositRouteType } from '@yearn/deposit/widget/deposit/types'
import { useDepositError } from '@yearn/deposit/widget/deposit/useDepositError'
import { useDepositFlow } from '@yearn/deposit/widget/deposit/useDepositFlow'
import { useDepositNotifications } from '@yearn/deposit/widget/deposit/useDepositNotifications'
import { useFetchMaxQuote } from '@yearn/deposit/widget/deposit/useFetchMaxQuote'
import { VaultSharesOverlay } from '@yearn/deposit/widget/deposit/VaultSharesOverlay'
import { VaultShareValueOverlay } from '@yearn/deposit/widget/deposit/VaultShareValueOverlay'
import { calculateDepositValueInfo } from '@yearn/deposit/widget/deposit/valuation'
import { InputTokenAmount } from '@yearn/deposit/widget/InputTokenAmount'
import { SettingsPanel } from '@yearn/deposit/widget/SettingsPanel'
import { PriceImpactWarning } from '@yearn/deposit/widget/shared/PriceImpactWarning'
import { TokenSelectorOverlay } from '@yearn/deposit/widget/shared/TokenSelectorOverlay'
import { TransactionOverlay, type TransactionStep } from '@yearn/deposit/widget/shared/TransactionOverlay'
import { useProtectedEnsoQuoteState } from '@yearn/deposit/widget/shared/useProtectedEnsoQuoteState'
import { useResetEnsoSelection } from '@yearn/deposit/widget/shared/useResetEnsoSelection'
import { useWidgetContext } from '@yearn/deposit/widget/shared/useWidgetContext'
import { formatWidgetAllowance, formatWidgetValue } from '@yearn/deposit/widget/shared/valueDisplay'
import { WidgetHeader } from '@yearn/deposit/widget/shared/WidgetHeader'
import { WidgetLoadingSkeleton } from '@yearn/deposit/widget/shared/WidgetLoadingSkeleton'
import { getKnownVaultTokenLogoMetaByAddress } from '@yearn/deposit/widget/tokenLogo.utils'
import { DEPOSIT_COMMON_TOKENS_BY_CHAIN } from '@yearn/deposit/widget/withdraw/constants'
...
export function WidgetDeposit({
  ...
  const handleDepositSuccess = useCallback(() => {
    ...
    trackEvent(WIDGET_EVENTS.DEPOSIT, {
      props: {
