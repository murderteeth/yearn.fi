...
import { PERMIT_ABI, type TPermitSignature } from '@yearn/deposit/hooks/usePermit'
...
import { useMigrateError } from '@yearn/deposit/widget/migrate/useMigrateError'
import { useMigrateFlow } from '@yearn/deposit/widget/migrate/useMigrateFlow'
import { TransactionOverlay, type TransactionStep } from '@yearn/deposit/widget/shared/TransactionOverlay'
import { formatWidgetValue } from '@yearn/deposit/widget/shared/valueDisplay'
...
export const WidgetMigrate: FC<Props> = ({
  ...
  const { openLoginModal } = useYearnWallet()
  ...
  const handleMigrateSuccess = useCallback(() => {
    trackEvent(WIDGET_EVENTS.MIGRATE, {
      props: {
