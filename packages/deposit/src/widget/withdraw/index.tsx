...
import {
  formatWidgetAllowance,
  formatWidgetPreciseValue,
  formatWidgetValue
} from '@yearn/deposit/widget/shared/valueDisplay'
...
import { getPriorityTokens } from '@yearn/deposit/widget/withdraw/constants'
import { SourceSelector } from '@yearn/deposit/widget/withdraw/SourceSelector'
import { buildSafeWithdrawBatch } from '@yearn/deposit/widget/withdraw/safeWithdrawBatch'
import type { WithdrawalSource, WithdrawWidgetProps } from '@yearn/deposit/widget/withdraw/types'
import { useWithdrawError } from '@yearn/deposit/widget/withdraw/useWithdrawError'
import { useWithdrawFlow } from '@yearn/deposit/widget/withdraw/useWithdrawFlow'
import { useWithdrawNotifications } from '@yearn/deposit/widget/withdraw/useWithdrawNotifications'
import { calculateWithdrawValueInfo } from '@yearn/deposit/widget/withdraw/valuation'
import { WithdrawDetails } from '@yearn/deposit/widget/withdraw/WithdrawDetails'
import { WithdrawDetailsOverlay } from '@yearn/deposit/widget/withdraw/WithdrawDetailsOverlay'
import {
  ...
  isWithdrawLastStep
} from '@yearn/deposit/widget/withdraw/withdrawStepHelpers'
import { toAddress } from '@yearn/util/utils/address'
import { cl } from '@yearn/util/utils/cl'
import { formatTAmount, toNormalizedBN } from '@yearn/util/utils/format'
...
export function WidgetWithdraw({
  ...
  const handleWithdrawSuccess = useCallback(() => {
    ...
    trackEvent(WIDGET_EVENTS.WITHDRAW, {
      props: {
