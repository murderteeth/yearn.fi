...
import { IconLoader } from '@yearn/components/icons/IconLoader'
import { IconWallet } from '@yearn/components/icons/IconWallet'
import type { TNotification, TNotificationStatus } from '@yearn/components/types/notifications'
...
import { useTransactionStatusPoller } from '@yearn/deposit/hooks/useTransactionStatusPoller'
...
import { getAwaitingExecutionEntries } from '@yearn/deposit/widget/WalletPanel.helpers'
import {
  formatDuration,
  parseCooldownStatus,
...
export const WalletPanel: FC<WalletPanelProps> = ({
  ...
  const { address, isActive: isWalletActive, openLoginModal } = useYearnWallet()
