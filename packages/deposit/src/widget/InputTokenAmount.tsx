...
import type { useDebouncedInput } from '@yearn/deposit/hooks/useDebouncedInput'
import type { useInput } from '@yearn/deposit/hooks/useInput'
import { getTokenLogoSources } from '@yearn/deposit/widget/tokenLogo.utils'
import { cl } from '@yearn/util/utils/cl'
import { formatCounterValue, formatTAmount, simpleToExact } from '@yearn/util/utils/format'
...
export const InputTokenAmount: FC<Props> = ({
  ...
  const handleInputChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    onInputChange?.(simpleToExact(event.target.value, decimals ?? input[0].decimals))
  }
