...
/**
 * Chain-generic constants now live in `@yearn/util` and are re-exported here so
 * the existing `@shared/utils/constants` import path keeps working. The Yearn
 * protocol addresses below are domain knowledge and move to `@yearn/vaults`.
 */
export {
