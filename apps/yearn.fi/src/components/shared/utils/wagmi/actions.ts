import { getEthZapperContract } from '@pages/vaults/utils/nativeTokens'
import type { TCTA } from '@shared/components/yToast'
import { ERC_4626_ROUTER_ABI } from '@shared/contracts/abi/erc4626Router.abi'
import { PARTNER_VAULT_ABI } from '@shared/contracts/abi/partner.vault.abi'
import { VAULT_ABI } from '@shared/contracts/abi/vault.abi'
...
import { ZAP_ETH_TO_YVETH_ABI } from '@shared/contracts/abi/zapEthToYvEth.abi'
import { ZAP_FTM_TO_YVFTM_ABI } from '@shared/contracts/abi/zapFtmToYvFTM.abi'
import { ZAP_OPT_ETH_TO_YVETH_ABI } from '@shared/contracts/abi/zapOptEthToYvEth'
import type { TAddress } from '@shared/types/address'
import { assert, assertAddress } from '@shared/utils/assert'
import { MAX_UINT_256 } from '@shared/utils/constants'
import { toAddress } from '@shared/utils/tools.address'
import { retrieveConfig } from '@shared/utils/wagmi/config'
import type { TWriteTransaction } from '@shared/utils/wagmi/provider'
import { handleTx, toWagmiProvider } from '@shared/utils/wagmi/provider'
import type { TTxResponse } from '@shared/utils/wagmi/transaction'
