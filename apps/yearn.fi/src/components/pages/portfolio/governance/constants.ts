...
// The only user-facing reward claim. It aggregates stYFI, stYFIx, migrated veYFI, and liquid-locker rewards.
export const GOVERNANCE_REWARD_CLAIMER_ADDRESS = toAddress('0xA82454009E01Ae697012a73cB232d85e61B05e50')
export const LEGACY_VEYFI_ADDRESS = toAddress('0x90c1f9220d90d3966FbeE24045EDd73E1d588aD5')
// Read directly only for migrated veYFI position metadata; rewards are claimed through the aggregate claimer above.
...
export const GOVERNANCE_REWARD_CLAIMER_ABI = parseAbi([
...
export const MIGRATED_VEYFI_ABI = parseAbi([
