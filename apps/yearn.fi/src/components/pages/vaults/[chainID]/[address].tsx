...
import { useWalletActions, useWalletStatus, useWalletTokens } from '@yearn/deposit/contexts/useWallet'
...
import type { TWidgetRef } from '@yearn/deposit/widget/index'
import { Widget } from '@yearn/deposit/widget/index'
import { MobileDrawerSettingsButton } from '@yearn/deposit/widget/MobileDrawerSettingsButton'
import { WidgetRewards } from '@yearn/deposit/widget/rewards/index'
import { WalletPanel } from '@yearn/deposit/widget/WalletPanel'
import { YvBtcWidget } from '@yearn/deposit/widget/yvBTC/YvBtcWidget'
import { YvUsdWidget } from '@yearn/deposit/widget/yvUSD/YvUsdWidget'
...
function Index(): ReactElement | null {
  ...
  const unlockedYvUsdPath = `/vaults/${YVUSD_CHAIN_ID}/${YVUSD_UNLOCKED_ADDRESS}${currentSearch ? `?${currentSearch}` : ''}${currentHash}`
