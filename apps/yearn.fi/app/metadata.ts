...
import { fetchWithSchema } from '@yearn/components/utils/fetchQuery'
...
import { kongVaultSnapshotSchema, type TKongVaultSnapshot } from '@yearn/vaults/schemas/kongVaultSnapshotSchema'
